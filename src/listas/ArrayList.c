...
int obterElementoEmPosicao(struct arraylist* lista, int posicao) {
  if (posicao >= 0 && posicao < lista->capacidade && lista->qtdade > 0) return lista->vetor[posicao];
}
